...
def add_python_version_specific_paths():
    ...
    if sys.version_info < (3, 0):
        sys.path.append(make_splunkhome_path(['etc', 'apps', 'splunk_app_cloudgateway', 'lib', 'py2']))
    else:
        sys.path.append(make_splunkhome_path(['etc', 'apps', 'splunk_app_cloudgateway', 'lib', 'py3']))
