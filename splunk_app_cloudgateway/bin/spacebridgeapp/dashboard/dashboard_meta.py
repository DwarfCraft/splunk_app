...
def fetch_dashboard_meta(request_context,
                         dashboard_id=None,
    ...
    response = yield async_kvstore_client.async_kvstore_get_request(collection=DASHBOARD_META_COLLECTION_NAME,
    ...
    if response.code == http.OK:
        ...
        if response_json and dashboard_id:
            ...
            defer.returnValue(dashboard_meta)
...
@defer.inlineCallbacks
def set_dashboard_meta(request_context, dashboard_meta=None, async_kvstore_client=None):
    """
    ...
    response = yield fetch_dashboard_meta(request_context=request_context,
    ...
    defer.returnValue(dashboard_id)
