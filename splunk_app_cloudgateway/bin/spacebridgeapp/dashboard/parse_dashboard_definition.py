...
def to_dashboard_definition(request_context=None,
                            app_name="",
                            root=None,
                            dashboard_id="",
                            show_refresh=True,
    ...
    for row_index, row_element in enumerate(row_elements):
        dashboard_row, ar_compatible_row = yield to_dashboard_row(request_context=request_context,
                                                                  app_name=app_name,
    ...
    defer.returnValue(DashboardDefinition(dashboard_id=dashboard_id,
                                          title=title,
...
@defer.inlineCallbacks
def to_dashboard_row(request_context, app_name, row_element, row_index, dashboard_refresh=None, show_refresh=True,
                     search_mapper=None, async_splunk_client=None):
    """
    ...
    for panel_index, panel_element in enumerate(panel_elements):
        dashboard_panel, ar_compatible_panel = yield to_dashboard_panel(request_context=request_context,
                                                                        app_name=app_name,
...
@defer.inlineCallbacks
def to_dashboard_panel(request_context, app_name, panel_element, row_index, panel_index, dashboard_refresh=None,
    ...
    for child_element in panel_element:
        ...
        if visualization_type:
            visualization, ar_compatible_visualization = yield to_dashboard_visualization(
...
@defer.inlineCallbacks
def to_dashboard_visualization(request_context,
                               app_name,
                               element,
                               row_index,
                               panel_index,
    ...
    if search.ref:
        try:
            saved_search = yield fetch_saved_search(auth_header=request_context.auth_header,
