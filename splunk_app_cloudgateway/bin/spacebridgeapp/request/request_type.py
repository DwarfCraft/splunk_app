...
class RequestType(Enum):
    ...
    NLP_SAVED_SEARCH_GET_SPL_REQUEST = "savedSearchSPLGetRequest"
    NLP_SAVED_SEARCH_SYNC_REQUEST = "savedSearchesSyncRequest"
    NLP_DASHBOARDS_SYNC_REQUEST = "dashboardsSyncRequest"
