...
def process_connectivity_test_request(request_context,
                                      encryption_context,
    ...
    response = yield async_spacebridge_client.async_send_message_request(auth_header=SpacebridgeAuthHeader(sender_id),
    ...
    defer.returnValue(server_single_response)
