...
def process_udf_hosted_resource_get(request_context,
    ...
    if resource_type == HostedResourceType.KVSTORE:
        ...
        r = yield async_kvstore_client.async_kvstore_get_request(collection,
        ...
        device_info = yield fetch_device_info(request_context.raw_device_id, async_kvstore_client,
                                              request_context.system_auth_header)
        ...
        r = yield async_spacebridge_client.async_send_storage_request(payload, mime, signature,
                                                                      SpacebridgeAuthHeader(sender_id),
                                                                      request_context.request_id)
        response = yield r.content()
        ...
        if r.code != http.OK:
            raise SpacebridgeApiRequestError("Exception storing resource to cloudgateway with code={}, error_msg={}"
                                             .format(r.code, storage_response))
