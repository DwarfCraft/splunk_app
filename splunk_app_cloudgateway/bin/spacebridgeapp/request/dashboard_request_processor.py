...
from spacebridgeapp.search.input_token_support import inject_tokens_into_string, set_default_token_values, inject_time_tokens
...
def process_dashboard_list_request(request_context,
    ...
    yield populate_dashboard_list_response(
        request_context, client_single_request, server_single_response, async_client_factory)


@defer.inlineCallbacks
def process_dashboard_get_request(request_context,
                                  client_single_request,
                                  server_single_response,
                                  async_client_factory):
    """
    ...
    yield populate_dashboard_get_response(
        request_context, client_single_request, server_single_response, async_client_factory)


@defer.inlineCallbacks
def process_dashboard_set_request(request_context,
                                  client_single_request,
                                  server_single_response,
    ...
    yield populate_dashboard_set_response(
        request_context, client_single_request, server_single_response, async_kvstore_client)


@defer.inlineCallbacks
def process_dashboard_data_request(request_context,
                                   client_single_request,
                                   server_single_response,
                                   async_client_factory):
    """
    ...
    :return:
    """
    yield populate_dashboard_data_response(
        request_context, client_single_request, server_single_response, async_client_factory)


@defer.inlineCallbacks
def populate_dashboard_list_response(request_context,
                                     client_single_request,
    ...
    dashboard_bodies, total = yield fetch_dashboard_descriptions(request_context=request_context,
                                                                 offset=offset,
    ...
    send_dashboard_list_request_metrics_to_telemetry(DASHBOARD_LIST_REQUEST, latency, request_context,
...
@defer.inlineCallbacks
def fetch_dashboard_descriptions(request_context,
                                 offset=0,
                                 max_results=0,
                                 dashboard_ids=None,
                                 minimal_list=False,
    ...
    # Set max_results to dashboard_list_max_count if specified in cloudgateway.conf
    ...
    response_json = yield fetch_dashboard_list_json(request_context=request_context,
                                                    offset=offset,
                                                    max_results=max_results,
                                                    app_names=app_names,
                                                    dashboard_ids=dashboard_ids,
    ...
    for entry_json in entry_json_list:
        try:
            if minimal_list:
                dashboard_description = yield parse.to_minimal_dashboard_description(
                    entry_json, request_context=request_context, async_splunk_client=async_splunk_client)
            else:
                dashboard_description = yield parse.to_dashboard_description(
    ...
    if async_kvstore_client is not None:
        dashboard_meta_dict = yield fetch_dashboard_meta(request_context=request_context,
                                                         async_kvstore_client=async_kvstore_client)
    ...
    defer.returnValue(return_tuple)


@defer.inlineCallbacks
def populate_dashboard_get_response(request_context,
                                    client_single_request,
                                    single_server_response,
                                    async_client_factory):
    """
    ...
    dashboard_body = yield fetch_dashboard_description(request_context=request_context,
...
@defer.inlineCallbacks
def populate_dashboard_set_response(request_context,
                                    client_single_request,
                                    single_server_response,
                                    async_kvstore_client):
    """
    ...
    dashboard_id = yield set_dashboard_meta(request_context=request_context,
...
@defer.inlineCallbacks
def fetch_dashboard_description(request_context,
                                dashboard_id=None,
                                show_refresh=True,
                                async_splunk_client=None,
                                async_kvstore_client=None):
    ...
    response = yield async_splunk_client.async_get_dashboard_request(
    ...
    dashboard = yield parse.to_dashboard_description(entry_json_list[0],
                                                     request_context=request_context,
                                                     async_splunk_client=async_splunk_client,
                                                     show_refresh=show_refresh)

    if async_kvstore_client is not None:
        dashboard_meta = yield fetch_dashboard_meta(request_context=request_context,
                                                    dashboard_id=dashboard_id,
                                                    async_kvstore_client=async_kvstore_client)
        if dashboard_meta:
            dashboard.is_favorite = dashboard_meta.is_favorite

    defer.returnValue(dashboard)


@defer.inlineCallbacks
def populate_dashboard_data_response(request_context,
                                     client_single_request,
                                     single_server_response,
                                     async_client_factory):
    """
    ...
    # fetch dashboard body
    dashboard_description = yield fetch_dashboard_description(request_context=request_context,
                                                              dashboard_id=dashboard_id,
                                                              async_splunk_client=async_splunk_client,
                                                              async_kvstore_client=async_kvstore_client)
    ...
    if visualization is None:
        raise SpacebridgeApiRequestError('Visualization ID not found! dashboard_id={}, visualization_id={}'.format(
            dashboard_id, visualization_id), status_code=http.NOT_FOUND)

    # make search call if visualization is present
    dashboard_data = yield fetch_dashboard_data(request_context=request_context,
...
def fetch_dashboard_data(request_context,
    ...
    visualization_data = yield fetch_visualization_data(request_context=request_context,
                                                        owner=owner,
                                                        app_name=app_name,
                                                        visualization=visualization,
                                                        async_splunk_client=async_splunk_client)
    ...
    defer.returnValue(DashboardData(dashboard_visualization_id=dashboard_visualization_id,
                                    visualization_data=visualization_data))


@defer.inlineCallbacks
def fetch_visualization_data(request_context,
                             owner=None,
                             app_name=None,
                             visualization=None,
                             async_splunk_client=None):
    ...
    response = yield async_splunk_client.async_get_search_data_request(owner=owner,
                                                                       app_name=app_name,
...
@defer.inlineCallbacks
def get_list_dashboard_data(request_context, dashboard_description=None, async_splunk_client=None, input_tokens=None):
    ...
    if dashboard_description is not None:
        ...
        for visualization in list_dashboard_visualizations:
            ...
            dashboard_data = yield fetch_dashboard_data(request_context,
                                                        dashboard_visualization_id=dashboard_visualization_id,
                                                        visualization=visualization,
                                                        async_splunk_client=async_splunk_client,
                                                        input_tokens=input_tokens)
    ...
    defer.returnValue(list_dashboard_data)


@defer.inlineCallbacks
def get_search_job_content(auth_header, owner=None, app_name=None, search_id=None, async_splunk_client=None, params={}):
    """
    ...
    response = yield async_splunk_client.async_get_search_job_request(owner=owner,
                                                                      app_name=app_name,
                                                                      search_id=search_id,
                                                                      params=params,
...
@defer.inlineCallbacks
def fetch_search_job_results_visualization_data(auth_header,
                                                owner=None,
                                                app_name=None,
                                                search_id=None,
                                                post_search=None,
    ...
    try:
        response = yield async_splunk_client.async_get_search_job_results_preview_request(owner=owner,
                                                                                          app_name=app_name,
                                                                                          search_id=search_id,
                                                                                          params=params,
                                                                                          auth_header=auth_header)
        ...
        LOGGER.exception('Unhandled Exception! owner={}, app_name={}, search_id={}'.format(owner, app_name, search_id))
        defer.returnValue(None)


@defer.inlineCallbacks
def get_search_job_dashboard_data(request_context,
                                  owner=None,
                                  app_name=None,
                                  search_id=None,
                                  dashboard_visualization_id=None,
    ...
    """
    try:
        visualization_data = yield fetch_search_job_results_visualization_data(owner=owner,
                                                                               app_name=app_name,
                                                                               search_id=search_id,
                                                                               auth_header=request_context.auth_header,
                                                                               async_splunk_client=async_splunk_client)
