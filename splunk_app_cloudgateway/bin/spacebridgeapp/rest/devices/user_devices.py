...
class DevicesForUser(BaseRestHandler, PersistentServerConnectionApplication):
    ...
    def get(self, request):
        ...
        if 'user' in request['query'] and isinstance(request['query']['user'], unicode):
...
def public_keys_for_device(device_id, auth_header, async_kvstore_client):
    """
    ...
    response = yield async_kvstore_client.async_kvstore_get_request(constants.DEVICE_PUBLIC_KEYS_COLLECTION_NAME,
