...
class KVStoreCollectionAccessObject(object):
    def __init__(self, collection=None, session_key=None, owner=NOBODY, timestamp_attribute_name='timestamp'):
        rest_uri = rest.makeSplunkdUri()
        self.uri = unicode(encode_whitespace('{}servicesNS/{}/{}/storage/collections/data/{}'.format(
            rest_uri,
            owner,
