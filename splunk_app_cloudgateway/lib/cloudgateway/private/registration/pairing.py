...
def pair_device_with_sb(auth_code, auth_header, device_id, encrypt_pubic_key, sign_public_key,
    ...
    try:
        response = make_device_pairing_req(auth_code, auth_header, sb_request_proto, config)
...
def make_device_pairing_req(auth_code, auth_header, sb_request_proto, config):
    """
