...
from cloudgateway.private.registration.util import sb_client_auth_endpoint, sb_auth_header, sb_client_auth_result_endpoint, \
    sb_mdm_authentication_endpoint
...
from cloudgateway.device import CredentialsBundle, DeviceInfo
...
def make_authentication_result_request(auth_code, encryption_context, config):
