            ...
            try:
                ...
                if isinstance(response, (list,)):
                    self.logger.debug("sending list of size={} back to sender, request_id={}".format(len(response),
                                                                                                     request_id))
                    for r in response:
                        send_response(message_sender, r, device_encryption_info, websocket_protocol, self.logger)
                    ...
                    send_response(message_sender, response, device_encryption_info, websocket_protocol, self.logger)
